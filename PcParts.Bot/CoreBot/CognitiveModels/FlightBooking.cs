...
namespace CoreBot
{
    public partial class FlightBooking : IRecognizerConvert
    {
        ...
        public class _Entities
        {
            ...
            {
                public string[][] Airport;
                [JsonProperty("$instance")] public _InstanceFrom _instance;
            }
            ...
            {
                public string[][] Airport;
                [JsonProperty("$instance")] public _InstanceTo _instance;
            }
        ...
        public void Convert(dynamic result)
        {
            var app = JsonConvert.DeserializeObject<FlightBooking>(JsonConvert.SerializeObject(result,
                new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore, MaxDepth = null }));
            Text = app.Text;
